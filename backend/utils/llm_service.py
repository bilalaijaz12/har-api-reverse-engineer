...
def identify_api_request(api_requests: List[Dict[str, Any]], description: str) -> Dict[str, Any]:
    ...
    system_prompt = """You are an expert at identifying API requests from HAR files.
    ...
    Return ONLY the most relevant API request as a JSON object, exactly as it appears in the list above.
    DO NOT modify the structure or content of the selected request in any way.
    """
